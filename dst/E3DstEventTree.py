...
class E3DstEventTree(E3Tree):
    ...
    BRANCHES = [E3BranchDescriptor('RunNumber', 'i'),
                ...
                E3BranchDescriptor('PosXBot2T', 'F'),
                E3BranchDescriptor('PosYBot2T', 'F'),
                E3BranchDescriptor('TimeBot2T', 'F'),
                E3BranchDescriptor('PosXMid2T', 'F'),
                E3BranchDescriptor('PosYMid2T', 'F'),
                E3BranchDescriptor('TimeMid2T', 'F'),
                E3BranchDescriptor('PosXTop2T', 'F'),
                E3BranchDescriptor('PosYTop2T', 'F'),
                E3BranchDescriptor('TimeTop2T', 'F'),
                E3BranchDescriptor('IntersectXMid2T', 'F'),
                E3BranchDescriptor('IntersectYMid2T', 'F'),
                E3BranchDescriptor('IntersectZMid2T', 'F'),
                E3BranchDescriptor('XDir2T', 'F'),
                E3BranchDescriptor('YDir2T', 'F'),
                E3BranchDescriptor('ZDir2T', 'F'),
                E3BranchDescriptor('ChiSquare2T', 'F'),
                E3BranchDescriptor('TimeOfFlight2T', 'F'),
                E3BranchDescriptor('TrackLength2T', 'F')
            ]
