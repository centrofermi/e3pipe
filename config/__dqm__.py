...
DQM_BASELINE_LIST = [
    ...
    ('HitMultTop', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
    ('HitMultMid', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
    ('HitMultBot', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
    ('HitMultTotal', 'x_average', 1.5, 2.5, 6, 9, dict(Logy = True)),
    ('ClusterMultTop', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
    ('ClusterMultMid', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
    ('ClusterMultBot', 'x_average', 0.5, 0.75, 2.1, 3, dict(Logy = True)),
